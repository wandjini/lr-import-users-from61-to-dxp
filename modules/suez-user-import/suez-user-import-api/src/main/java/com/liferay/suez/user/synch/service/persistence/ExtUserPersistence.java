...
/**
 * The persistence interface for the ext user service.
 *
 * <p>
 ...
 */
@ProviderType
public interface ExtUserPersistence extends BasePersistence<ExtUser> {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ExtUserUtil} to access the ext user persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	...
	*/
	public void cacheResult(java.util.List<ExtUser> extUsers);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, ExtUser> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<ExtUser> findAll();
	...
	*/
	public java.util.List<ExtUser> findAll(int start, int end);
	...
	*/
	public java.util.List<ExtUser> findAll(int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<ExtUser> orderByComparator);
