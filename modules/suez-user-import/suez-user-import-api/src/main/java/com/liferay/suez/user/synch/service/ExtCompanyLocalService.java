...
/**
 * Provides the local service interface for ExtCompany. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ExtCompanyLocalServiceUtil
...
public interface ExtCompanyLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ExtCompanyLocalServiceUtil} to access the ext company local service. Add custom service methods to {@link com.liferay.suez.user.synch.service.impl.ExtCompanyLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
