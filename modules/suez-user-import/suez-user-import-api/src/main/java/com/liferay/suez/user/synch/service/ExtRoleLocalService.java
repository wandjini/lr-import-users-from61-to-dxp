...
/**
 * Provides the local service interface for ExtRole. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ExtRoleLocalServiceUtil
...
public interface ExtRoleLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ExtRoleLocalServiceUtil} to access the ext role local service. Add custom service methods to {@link com.liferay.suez.user.synch.service.impl.ExtRoleLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
